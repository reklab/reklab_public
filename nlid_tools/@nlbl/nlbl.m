classdef nlbl < nlm
    ...
    methods
        function nl  = nlbl (z, varargin)
            ...
            nl.comment='NL Model';
            nl.parameterSet(1) =param('paramName','idMethod','paramDefault','hk', ...
                'paramHelp','identification method: hk - Hunter Korenberg;  sls - separated least squares subspace  ',...
                'paramType','select','paramLimits',{'hk' 'sls' 'subspace'});
            i=irf;
