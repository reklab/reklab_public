function [coeffs,range,IRF,num_iterations] = tv_nlbl_ident_ensemble(x,y,dt,order,M1,M2,tol)
...
IRF = tvIdentEnsemble(x,y,dt,1,numlags,'pseudo');% 27/10/08 TSV -changed from 'corr' to 'pseudo'
...
%       end
    ...
    disp(['time instant: ' num2str(i-M2)  'VAF ' num2str(VAFnew)])
   end  % while
