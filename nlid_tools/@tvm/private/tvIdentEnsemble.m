function [Hident,bound,sing_vectors,cpu] = tvIdentEnsemble(X,Y,dt,nSides,nLags,approach,conf_level)
 
% Identifies dynamics of linear time-varying system from ensemble
% statistics
%
...
% nSide  =  1 -> (1-sided IRF) or 2->  (2-sided IRF)
% nLags  = length of (i.e. number of points in) the IRF
...
if (nSides==1) | (nSides==2)
   ...
   elseif (nSides==2)   % Two sided IRF 
      ...
      error( 'Nsides must be 1 or 2 or a non-positive integer.')
   end
end
