...
% Kian Jalaleddini Modified this routine to account for zero-th order systems (Feb, 20, 2012).
...
if nargin==2
  ...
  elseif method=='gui'
    ...
    %Added by Kian
    %From this line
    H=semilogy(x_axis,S,'x');
    %Original: H=semilogy(S,'x');
    %Until Here
    set(H,'ButtonDownFcn','orderselect(2,''bdf'');');
    hold on
    plot(order,S(order+1),'r.');
