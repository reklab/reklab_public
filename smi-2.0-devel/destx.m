 function x0 = destx(u,y,A,B,C,D); 
 % destx     Estimates the initial state of a state space system on the 
%           basis of the system matrices and a set of input/output data. 
% 
% Syntax: 
...
[Phi,T] = dcalcphi(u,y,A,C,[0 0 1 0 0]); 
