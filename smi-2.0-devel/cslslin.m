...
% 
% Syntax: 
%          [A,B,C,D]=cslslin(u,y,Ts,A,C) 
%          [A,B,C,D,x0,K,options]=cslslin(u,y,Ts,A,C,K,model,partype options) 
% Input: 
...
% See also:    foptions, dslsbil 
 
%  --- This file is cslslin.m generated from the MWEB source cslslin.web --- 
% 
...
thn = css2th(A,C,params.partype); 
[thn,options] = leastsq('cfunlin',thn,options,[],u,y,Ts,params); 
